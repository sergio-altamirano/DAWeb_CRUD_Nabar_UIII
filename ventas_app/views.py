...
def registrarVentas(request):
    ...
    guardarVentas=Ventas.objects.create(id_venta=id_venta,id_trabajador=id_trabajador, id_producto=id_producto, id_cliente=id_cliente, fecha_venta=fecha_venta, id_sucursal=id_sucursal, cantidad=cantidad,pago=pago )
...
def editarVentas(request):
    ...
    ventas.id_trabajador=id_trabajador
